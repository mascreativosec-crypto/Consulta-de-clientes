...
<body>
    ...
    <div class="header">
        ...
        <div class="header-title">Sistema de Gestión de Pagos</div>
        <div class="header-subtitle">Consulta de Información de Clientes y Registro de Mensualidades</div>
    </div>

    <!-- CONTENIDO PRINCIPAL -->
    <div class="container">
        <h1>🔍 Consulta de Cliente</h1>
        <p class="subtitle">Busca clientes por contrato, nombre o cédula</p>
    ...
    <!-- FOOTER -->
    <div class="footer">
        <p>© 2026 Eureka! Education - Sistema de Gestión de Pagos</p>
        <p style="margin-top: 5px; opacity: 0.7; font-size: 12px;">Todos los derechos reservados</p>
    </div>
